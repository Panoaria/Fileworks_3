...
Public Class cRTBWrapper
        ...
        Function exists(ByVal lookup As Integer) As Integer
            ...
            If List.Count <> 0 Then
                For current = 0 To List.Count - 1
                    ...
                    Dim source As Color = Color.FromArgb(Convert.ToInt32(List(current)))
                    ...
                    If compare.R = source.R And
                       compare.G = source.G And
    ...
    Private Function readRTFColor() As Boolean
        ...
        If Not colColors Is Nothing Then
            ...
            For colorCounter = 0 To colColors.Count - 1 Step 3
                Dim newColor As Color = Color.FromArgb(0,
                                        CInt(colColors.Item(colorCounter).Value),
                                        CInt(colColors.Item(colorCounter + 1).Value),
                                        CInt(colColors.Item(colorCounter + 2).Value))
    ...
    '
    Public Function changeColor(ByVal index As Integer, ByVal toColor As Color) As Object
        rtfColors.item(index) = toColor.ToArgb
    End Function
    ...
    '
    Private Function applyColor(ByVal line As Integer) As Object
    ...
    Public Function colorDocument() As Object
        Dim counter As Integer
